...
#LDLIBS=-lm  -lreflapacke -lreflapack -lblis -fopenmp  wcstools-3.9.2/libwcs/libwcs.a -I/usr/include/blis
#LDLIBS=-lm  -lpthread -lreflapacke -lgfortran -fopenmp -lopenblas_openmp  wcstools-3.9.2/libwcs/libwcs.a
LDLIBS=-lm  -lreflapacke -latllapack -lf77blas -latlas -latlcblas -fopenmp -I/usr/include/lapacke wcstools-3.9.2/libwcs/libwcs.a
DEFINE=NO_MKL
endif
