...
#LDLIBS=-lm  -lreflapacke -lptlapack -lptf77blas -latlas -latlcblas -fopenmp  wcstools-3.9.2/libwcs/libwcs.a
LDLIBS=-lm  -lpthread -lreflapacke -lgfortran -lopenblas_openmp -fopenmp  wcstools-3.9.2/libwcs/libwcs.a
